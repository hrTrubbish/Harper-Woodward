...
export default function Home () {
  return (
    <div className='flex flex-col border-t-2'>
      <div
        className='featured flex flex-col p-10'>
        <span
          className='text-3xl self-center'>featured video
        </span>
        <video
          className='h-90 mr-5 ml-5 border-dotted border-2 border'>
        </video>
        <div
      ...
      <div className='info flex flex-col p-10 border-t-2'>
        ...
        <div className='flex justify-around h-60'>
          <img
            className='w-3/12 border-dotted border-2'
          />
          <div className='flex flex-col self-center'>
            <span>THIS IS SOME INFO ABOUT BROOKS GARTH</span>
